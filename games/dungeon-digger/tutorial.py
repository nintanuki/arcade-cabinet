...
CARDS: dict[str, Card] = {
    ...
    "door": Card("door", "FIND A KEY TO OPEN THE DOOR WITH A OR SPACE.", QUEUE_FLOW),
    ...
    # ---- Item pickups ----
    "pickup_match": Card("pickup_match", "PRESS B OR F TO LIGHT THE MATCH.", QUEUE_BURST),
    "pickup_torch": Card("pickup_torch", "PRESS B OR F TO LIGHT THE TORCH.", QUEUE_BURST),
    "pickup_torch_tip": Card("pickup_torch_tip", "TORCHES PROVIDE MORE LIGHT THAN MATCHES.", QUEUE_BURST),
    "pickup_lantern": Card("pickup_lantern", "PRESS B OR F TO LIGHT THE LANTERN.", QUEUE_BURST),
    ...
    "pickup_repellent": Card("pickup_repellent", "PRESS Y OR R TO REPEL MONSTERS.", QUEUE_BURST),
    "pickup_detector": Card("pickup_detector", "PRESS X OR E TO LOCATE THE KEY.", QUEUE_BURST),
    ...
    "pickup_light_cycle": Card("pickup_light_cycle", "PRESS L1/R1 or Q/E TO CYCLE LIGHT SOURCES.", QUEUE_BURST),
