...
- All functions must have docstrings. If they take arguments or return a value, the docstring must have Args and Returns sections describing them.
- Do not remove comments unless necessary. Comments must explain *why*, not just what.
