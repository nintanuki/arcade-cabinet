...
class SessionStateManager:
    ...
    def reset_for_new_game(self) -> None:
        ...
        # Reset player position to left-side start for horizontal play.
        game.player.sprite.rect.center = ScreenSettings.PLAYER_START
...
class SpawnDirector:
    ...
    def alien_shoot(self) -> None:
        ...
        if random_alien.color == 'green':
            # Green aliens fire a double shot — two lasers spread above and below center.
            offset = 10
            game.alien_lasers.add(
                Laser(
                    pos=(random_alien.rect.centerx, random_alien.rect.centery - offset),
