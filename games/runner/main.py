...
test_font = pygame.font.Font(str(ASSET_DIR / 'font' / 'Pixeltype.ttf'), 50)
game_active = False
start_time = 0
score = 0
bg_music = pygame.mixer.Sound(str(ASSET_DIR / 'audio' / 'music.wav'))
...
sky_surface = pygame.image.load(str(ASSET_DIR / 'graphics' / 'Sky.png')).convert()
ground_surface = pygame.image.load(str(ASSET_DIR / 'graphics' / 'ground.png')).convert()

# Intro screen
player_stand = pygame.image.load(str(ASSET_DIR / 'graphics' / 'Player' / 'player_stand.png')).convert_alpha()
