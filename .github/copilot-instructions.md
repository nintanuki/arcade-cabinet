...
- When refactoring the launcher don't touch the game folders, they are agnostic to the launcher.
...
- `ArcadeLauncher` must be light — offload responsibilities to other classes.
- Classes should communicate through `ArcadeLauncher` where possible.
